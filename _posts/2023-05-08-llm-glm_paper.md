...
![GLM:blank infilling](imgs/20230508-glm/img.png)
...
1. 增强训练稳定性的结构改进
    ...
    - Layer Normalization：实验发现Pre-LN(bloom/GPT3/Opt/PaLM)、Post-LN(原始的transformer的方式)在GLM的结构下都无法使训练稳定。庆幸的是，尝试了基于 DeepNorm(Deepnet)中提出的方法(结合了Pre-LN和Post-LN优势)，来初始化Post-LN的方式可以让训练过程稳定。不同LN的介绍可查看：https://km.sankuai.com/collabpage/1660208982。

    ![img.png](imgs/20230508-glm/img2.png)                           
...
![img.png](imgs/20230508-glm/img3.png)
...
![img.png](imgs/20230508-glm/img4.png)                        
...
3. Quantization
   ...
   2) GLM’s INT4 Weight Quantization Scaling Law. 参考下图右。
    ...
    ![img.png](imgs/20230508-glm/img5.png)                                                                       

## 3.4 130B的效果

![img.png](imgs/20230508-glm/img6.png)   

1. LANGUAGE MODELING

LAMBADA（FIG2）   Pile BPB(Table 3)

![img.png](imgs/20230508-glm/img7.png)

2. MASSIVE MULTITASK LANGUAGE UNDERSTANDING (MMLU)（FIG6）

![img.png](imgs/20230508-glm/img8.png)

3. BIG-BENCH

![img.png](imgs/20230508-glm/img9.png)

4. CLUE（FIG8）

![img.png](imgs/20230508-glm/img10.png)